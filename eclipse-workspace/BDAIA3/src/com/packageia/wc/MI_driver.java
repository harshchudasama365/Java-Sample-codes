...
public class MI_driver
{
    ...
    {
        Path inputPath1 = new Path("http://localhost:9870/explorer.html#/input3/word1");

        Path inputPath2 = new Path("http://localhost:9870/explorer.html#/input3/word2");

        Path output_dir = new Path("http://localhost:9870/explorer.html#/out");
