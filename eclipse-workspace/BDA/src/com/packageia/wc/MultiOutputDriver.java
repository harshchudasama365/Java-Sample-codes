...
public class MultiOutputDriver
{
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException
    {
        ...
        Path inputPath = new Path("hdfs://localhost:9870/user/{user}/mo");         // input file path
        Path outputDir = new Path("hdfs://localhost:9870/user/{user}/output/");      // output directory path
